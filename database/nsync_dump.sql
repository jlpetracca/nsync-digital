...
CREATE TABLE `users` ( 
	...
	PRIMARY KEY ( `id` ) 
	, CONSTRAINT `users_email_unique` UNIQUE( `email` ) #TO UNCOMMENT
	)
CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_ci
ENGINE = InnoDB
...
CREATE TABLE `data_types` ( 
	...
	`updated_at` Timestamp NULL,
	PRIMARY KEY ( `id` )
	 ,CONSTRAINT `data_types_name_unique` UNIQUE( `name` ) #TO UNCOMMENT
	 ,CONSTRAINT `data_types_slug_unique` UNIQUE( `slug` ) #TO UNCOMMENT
	)
CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_ci
ENGINE = InnoDB
...
CREATE TABLE `posts` ( 
	...
	`updated_at` Timestamp NULL,
	PRIMARY KEY ( `id` )
	,CONSTRAINT `posts_slug_unique` UNIQUE( `slug` ) #TO UNCOMMENT
		 )
CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_ci
ENGINE = InnoDB
...
CREATE TABLE `menus` ( 
	...
	`updated_at` Timestamp NULL,
	PRIMARY KEY ( `id` )
	,CONSTRAINT `menus_name_unique` UNIQUE( `name` ) #TO UNCOMMENT
	)
CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_ci
ENGINE = InnoDB
...
CREATE TABLE `settings` ( 
	...
	PRIMARY KEY ( `id` )
	,CONSTRAINT `settings_key_unique` UNIQUE( `key` ) #TO UNCOMMENT
	)
CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_ci
ENGINE = InnoDB
...
CREATE TABLE `roles` ( 
	...
	`updated_at` Timestamp NULL,
	PRIMARY KEY ( `id` )
	, CONSTRAINT `roles_name_unique` UNIQUE( `name` ) #TO UNCOMMENT
	)
CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_ci
ENGINE = InnoDB
...
-- ---------------------------------------------------------
CREATE INDEX `password_resets_email_index` USING BTREE ON `password_resets`( `email` ); #TO UNCOMMENT
...
CREATE TABLE `pages` ( 
	...
	`updated_at` Timestamp NULL,
	PRIMARY KEY ( `id` )
	, CONSTRAINT `pages_slug_unique` UNIQUE( `slug` ) #TO UNCOMMENT
	)
CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_ci
ENGINE = InnoDB
...
CREATE TABLE `translations` ( 
	...
	`updated_at` Timestamp NULL,
	PRIMARY KEY ( `id` ),
	CONSTRAINT `translations_table_name_column_name_foreign_key_locale_unique` UNIQUE( `table_name`, `column_name`, `foreign_key`, `locale` ) #TO UNCOMMENT
	)
CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_ci
ENGINE = InnoDB
...
ALTER TABLE mage_eav_attribute_option_value ADD CONSTRAINT mage_eav_attribute_option_value_mage_eav_attribute_id_fk FOREIGN KEY (attribute_id) REFERENCES mage_eav_attribute (id);
...
-- ---------------------------------------------------------
ALTER TABLE mage_eav_entity_attribute ADD CONSTRAINT mage_eav_entity_attribute_mage_eav_attribute_id_fk FOREIGN KEY (attribute_id) REFERENCES mage_eav_attribute (id);
...
-- ---------------------------------------------------------
ALTER TABLE `mage_catalog_category_entity` ADD CONSTRAINT `fk_mage_tegory_entity_1_resume` FOREIGN KEY ( `parent_id` ) REFERENCES `mage_catalog_category_entity`( `id` ) ON DELETE Restrict ON UPDATE Restrict;
ALTER TABLE `mage_catalog_category_entity` ADD CONSTRAINT `fk_entity_mage_eav_entity_attribute_set_id_fk` FOREIGN KEY (attribute_set_id) REFERENCES mage_eav_entity_attribute (attribute_set_id);
...
ALTER TABLE nsync_stores ADD CONSTRAINT nsync_stores_nsync_marketplaces_id_fk FOREIGN KEY (marketplace_id) REFERENCES nsync_marketplaces (id);
...
-- -------------------------------------------------------------
-- ---------------------------------------------------------
ALTER TABLE tn_store ADD CONSTRAINT tn_store_nsync_stores_id_fk FOREIGN KEY (nsync_store_id) REFERENCES nsync_stores (id);
...
-- ---------------------------------------------------------
ALTER TABLE tn_webhooks ADD CONSTRAINT tn_webhooks_tn_store_id_fk FOREIGN KEY (tn_store_id) REFERENCES tn_store (id);
...
-- ---------------------------------------------------------
ALTER TABLE tn_categories ADD CONSTRAINT tn_categories_tn_store_id_fk FOREIGN KEY (tn_store_id) REFERENCES tn_store (id);
ALTER TABLE tn_categories ADD CONSTRAINT tn_categories_tn_categories_id_fk FOREIGN KEY (parent) REFERENCES tn_categories (id);
ALTER TABLE tn_categories ADD CONSTRAINT tn_categories_mage_catalog_category_entity_id_fk FOREIGN KEY (mage_category_entity_id) REFERENCES mage_catalog_category_entity (id);
...
-- ---------------------------------------------------------
ALTER TABLE tn_product_image ADD CONSTRAINT tn_product_image_tn_store_id_fk FOREIGN KEY (tn_store_id) REFERENCES tn_store (id);
ALTER TABLE tn_product_image ADD CONSTRAINT tn_product_image_tn_products_id_fk FOREIGN KEY (product_id) REFERENCES tn_products (id);
...
-- CREATE TABLE "tn_category_product" ------------------------------
-- CREATE TABLE "tn_category_product" ----------------------------------
CREATE TABLE `tn_category_product` (
...
UNIQUE INDEX `category_product` (`category_id` ASC, `product_id` ASC) USING BTREE,
...
-- ---------------------------------------------------------
ALTER TABLE tn_category_product ADD CONSTRAINT tn_category_product_tn_categories_id_fk FOREIGN KEY (category_id) REFERENCES tn_categories (id);
ALTER TABLE tn_category_product ADD CONSTRAINT tn_category_product_tn_products_id_fk FOREIGN KEY (product_id) REFERENCES tn_products (id);
ALTER TABLE tn_category_product ADD CONSTRAINT tn_category_product_tn_store_id_fk FOREIGN KEY (store_id) REFERENCES tn_store (id);
...
ENGINE = InnoDB;
-- ---------------------------------------------------------
ALTER TABLE tn_attributes ADD CONSTRAINT tn_attributes_tn_store_id_fk FOREIGN KEY (tn_store_id) REFERENCES tn_store (id);
ALTER TABLE tn_attributes ADD CONSTRAINT tn_attributes_mage_eav_attribute_id_fk FOREIGN KEY (mage_attribute_id) REFERENCES mage_eav_attribute (id);
...
-- ---------------------------------------------------------
ALTER TABLE tn_attributes_values ADD CONSTRAINT tn_attributes_values_tn_attributes_id_fk FOREIGN KEY (attribute_id) REFERENCES tn_attributes (id);
ALTER TABLE tn_attributes_values ADD CONSTRAINT tn_attributes_values_tn_store_id_fk FOREIGN KEY (tn_store_id) REFERENCES tn_store (id);
ALTER TABLE tn_attributes_values ADD CONSTRAINT tn_attributes_values_mage_eav_attribute_option_value_value_id_fk FOREIGN KEY (mage_value_id) REFERENCES mage_eav_attribute_option_value (value_id);
...
-- ---------------------------------------------------------
ALTER TABLE tn_variants ADD CONSTRAINT tn_variants_tn_store_id_fk FOREIGN KEY (tn_store_id) REFERENCES tn_store (id);
ALTER TABLE tn_variants ADD CONSTRAINT tn_variants_tn_products_id_fk FOREIGN KEY (product_id) REFERENCES tn_products (id);
...
-- CREATE TABLE "tn_variants_attributes" ---------------------
-- CREATE TABLE "tn_variants_attributes" ---------------------
CREATE TABLE `tn_variants_attributes` (
	`id` Int( 11 ) AUTO_INCREMENT NOT NULL,
	`tn_store_id` Int( 11 ) NOT NULL,
...
-- ---------------------------------------------------------
ALTER TABLE tn_variants_attributes ADD CONSTRAINT tn_variants_attributes_tn_store_id_fk FOREIGN KEY (tn_store_id) REFERENCES tn_store (id);
ALTER TABLE tn_variants_attributes ADD CONSTRAINT tn_variants_attributes_tn_products_id_fk FOREIGN KEY (product_id) REFERENCES tn_products (id);
ALTER TABLE tn_variants_attributes ADD CONSTRAINT tn_variants_attributes_tn_variant_id_fk FOREIGN KEY (variant_id) REFERENCES tn_variants (id);
ALTER TABLE tn_variants_attributes ADD CONSTRAINT tn_variants_attributes_tn_attributes_id_fk FOREIGN KEY (attribute_id) REFERENCES tn_attributes (id);
ALTER TABLE tn_variants_attributes ADD CONSTRAINT tn_variants_attributes_tn_attribute_values_value_id_fk FOREIGN KEY (attribute_value_id) REFERENCES tn_attributes_values (id);

-- ---------------------------------------------------------
CREATE INDEX `fk_tn_variants_attributes_mage_eav_attribute_option_1` USING BTREE ON `tn_attributes_values`( `mage_value_id` );
CREATE INDEX `fk_tn_variants_attributes_tn_attributes_1` USING BTREE ON `tn_attributes_values`( `attribute_id` );
CREATE INDEX `fk_tn_variants_attributes_tn_store_1` USING BTREE ON `tn_attributes_values`( `tn_store_id` );
